...
const Episodes: React.FC<EpisodesProps> = (props) => {
  ...
  return (
    <nav className="w-[25%] mt-8 bg-black-100 rounded-none  text-blue-400 h-[550px] max-h-[350px] lg:max-h-[790px]   md:max-h-[550px] lg:h-[790px]  overflow-y-auto overflow-x-hidden custom-scrollbar border-2 p-4 border-[rgb(59,130,246)]">
      <h2 className="mb-4 text-[8px] border-b-2 border-blue-400  sm:text-lg md:text-xl lg:text-2xl font-bold text-center">Episodes</h2>
            ...
            <li key={episode.id}>
              <a
                ...
                className={`font-style text-center transform transition-all duration-300 ${
                  episodeID === episode.id ? "border-2 border-blue-800 scale-105 shadow-lg" : ""
